...
Visit the [Prebid documentation](https://docs.prebid.org/prebid-mobile/pbm-api/android/code-integration-android.html) to study the available integration approaches or autogenerated [API documentation](https://docs.prebid.org/prebid-mobile-ios/index.html) for a description of available classes and methods.  
