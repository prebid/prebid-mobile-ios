...
typedef NS_ENUM(NSInteger, PBMVideoViewPlaybackState) {
    PBMVideoViewPlaybackStateUnstarted = 0,
    PBMVideoViewPlaybackStatePlaying,
    ...
    PBMVideoViewPlaybackStatePaused,
