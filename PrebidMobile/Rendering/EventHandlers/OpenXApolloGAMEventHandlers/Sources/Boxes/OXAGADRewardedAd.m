...
@implementation OXAGADRewardedAd
...
- (BOOL)isReady {
    ...
    [OXAInvocationHelper invokeCResultSelector:@selector(isReady)
...
- (void)setAdMetadataDelegate:(id<GADRewardedAdMetadataDelegate>)adMetadataDelegate {
    [OXAInvocationHelper invokeVoidSelector:@selector(setAdMetadataDelegate:)
...
- (id<GADRewardedAdMetadataDelegate>)adMetadataDelegate {
    ...
    [OXAInvocationHelper invokeProtocolResultSelector:@selector(adMetadataDelegate)
                                             onTarget:self.rewardedAd
...
- (NSDictionary<GADAdMetadataKey,id> *)adMetadata {
    ...
    [OXAInvocationHelper invokeClassResultSelector:@selector(adMetadata)
                                          onTarget:self.rewardedAd
...
- (NSObject *)reward {
    ...
    [OXAInvocationHelper invokeClassResultSelector:@selector(reward)
                                          onTarget:self.rewardedAd
...
- (void)loadRequest:(OXADFPRequest *)request completionHandler:(GADRewardedAdLoadCompletionHandler)completionHandler {
    [OXAInvocationHelper invokeVoidSelector:@selector(loadRequest:completionHandler:)
