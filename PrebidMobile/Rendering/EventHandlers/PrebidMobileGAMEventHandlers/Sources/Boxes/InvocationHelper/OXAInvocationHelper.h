...
extern NSExceptionName const OXAInvalidInvocationResultTypeException;
extern NSExceptionName const OXAVoidSelectorReturnedValueException;

@interface OXAInvocationHelper : NSObject
