...
class TestOXMFunctions: XCTestCase {
    ...
    func testInfoPlistValue() {
        ...
        XCTAssert(result?.OXMdoesMatch("OpenXApolloSDK") == true, "Got \(String(describing: result))")
        
        result = OXMFunctions.infoPlistValue("CFBundleIdentifier")
        XCTAssert(result?.OXMdoesMatch("com.openx.OpenXApolloSDK") == true, "Got \(String(describing: result))")
