...
class OXANativeFunctionsTest: XCTestCase {
...
""";
        ...
        let result = try! OXANativeFunctions.populateNativeAdTemplate(nativeTemplate, withTargeting: targeting)
