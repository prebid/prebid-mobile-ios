...
class OXMModalAnimatorTest: XCTestCase {
    
    var expectation:XCTestExpectation?
    
    func testPresentVC() {
        let frame = CGRect(x: 10.0, y: 10.0, width: 320.0, height: 50.0);
        let modalAnimator = OXMModalAnimator(frameOfPresentedView: frame)
        ...
        //to hold a weak ref to OXMModalAnimator.modalPresentationController
    ...
    func testControllerTransitioningDelegate() {
        ...
        XCTAssertEqual(modalAnimator, result as! OXMModalAnimator)
        XCTAssertTrue(modalAnimator.isPresented)
