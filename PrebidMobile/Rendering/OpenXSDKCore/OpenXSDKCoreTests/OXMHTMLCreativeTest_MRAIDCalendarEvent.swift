//
//  OXMHTMLCreativeTest_MRAIDCalendarEvent.swift
//  OpenXSDKCoreTests
//
...
class OXMHTMLCreativeTest_MRAIDCalendarEvent: OXMHTMLCreativeTest_Base {
    ...
    /**
     Setup an expectation and associated, mocked `OXMDeviceManager` to fulfill that expectation.
    ...
    func createCalendarEventExpectation(shouldFulfill: Bool, shouldSucceed: Bool? = nil, errorMessage: String = "") {
        ...
        MockOXMDeviceAccessManager.mock_createCalendarEventFromString_completion = { (_, completion) in
