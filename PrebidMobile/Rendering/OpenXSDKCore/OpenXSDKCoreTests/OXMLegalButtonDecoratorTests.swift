//
//  OXMLegalButtonDecoratorTests.swift
//  OpenXSDKCoreTests
//
...
class OXMLegalButtonDecoratorTests: XCTestCase {
    
    let buttonDecorator = OXMLegalButtonDecorator(position: .topRight)
    ...
    func testSetButtonPosition() {
        XCTAssertEqual(buttonDecorator.buttonPosition.rawValue, OXMPosition.topRight.rawValue,
                  "Wrong position, got \(String(describing: buttonDecorator.buttonPosition.rawValue))")
        
        buttonDecorator.buttonPosition = OXMPosition.bottomRight
        XCTAssertEqual(buttonDecorator.buttonPosition.rawValue, OXMPosition.bottomRight.rawValue,
                  "Wrong position, got \(String(describing: buttonDecorator.buttonPosition.rawValue))")
    }
}
