//
//  OXMAdViewButtonDecoratorTests.swift
//  OpenXSDKCoreTests
//
...
class OXMAdViewButtonDecoratorTests: XCTestCase {
    
    var buttonDecorator: OXMAdViewButtonDecorator!
    
    override func setUp() {
        super.setUp()
        buttonDecorator = OXMAdViewButtonDecorator()
    }
