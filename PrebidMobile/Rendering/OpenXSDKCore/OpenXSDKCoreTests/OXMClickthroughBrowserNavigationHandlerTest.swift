//
//  OXMClickthroughBrowserNavigationHandlerTest.swift
//  OpenXSDKCoreTests
//
...
class OXMClickthroughBrowserNavigationHandlerTest: XCTestCase {
    private var mockWebView: MockWebView!
    private var navigationHandler: OXMClickthroughBrowserNavigationHandler!
    
    override func tearDown() {
        mockWebView = nil
        navigationHandler = nil
        OXMDeepLinkPlusHelper.application = nil
        OXMDeepLinkPlusHelper.connection = OXMServerConnection.singleton()
    }
    ...
    func testOpenNormalURL_Ok() {
        ...
        navigationHandler = OXMClickthroughBrowserNavigationHandler(webView: mockWebView)
...
extension OXMClickthroughBrowserNavigationHandlerTest {
    private class MockWebView: NSObject, OXMWKWebViewCompatible {
