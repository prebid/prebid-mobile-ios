...
@class OXMORTBBanner;
@class OXMORTBImpExtPrebid;
@class OXMORTBImpExtSkadn;
@class OXMORTBNative;
@class OXMORTBPmp;
@class OXMORTBVideo;
...
@property (nonatomic, strong, nullable) OXMORTBBanner * banner;

//A Video object (Section 3.2.7); required if this impression is offered as a video ad opportunity.
@property (nonatomic, strong, nullable) OXMORTBVideo *video;
...
//TODO: clarify with Product if this should be informed by OpenXSDKConfiguration.useExternalClickthroughBrowser
...
@property (nonatomic, strong) OXMORTBImpExtPrebid *extPrebid;
@property (nonatomic, strong) OXMORTBImpExtSkadn  *extSkadn;
