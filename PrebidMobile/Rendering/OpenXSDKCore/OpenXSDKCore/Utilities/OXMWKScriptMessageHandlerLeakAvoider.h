//
//  OXMWKScriptMessageHandlerLeakAvoider.h
//  OpenXSDKCore
//
...
// Without it the instances of OXMWebView are never destroyed.
...
@interface OXMWKScriptMessageHandlerLeakAvoider : NSObject<WKScriptMessageHandler>
