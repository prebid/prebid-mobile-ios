...
@interface OXANativeAssetData : OXANativeAsset
...
@property (nonatomic, assign) OXADataAssetType dataType;
...
- (instancetype)initWithDataType:(OXADataAssetType)dataType NS_DESIGNATED_INITIALIZER;
