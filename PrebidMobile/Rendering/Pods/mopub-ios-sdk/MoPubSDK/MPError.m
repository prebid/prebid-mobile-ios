...
@implementation NSError (Viewability)
+ (instancetype)noViewToTrack {
    return [NSError errorWithCode:MOPUBErrorViewabilityNoViewToTrack localizedDescription:@"No view for Viewability to track."];
}
@end
