 ...
 */
@interface OMIDMopubAdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(OMIDMopubPartner *)partner
...
- (nullable instancetype)initWithPartner:(OMIDMopubPartner *)partner
                               ...
                               resources:(NSArray<OMIDMopubVerificationScriptResource *> *)resources
                              contentUrl:(nullable NSString *)contentUrl
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
