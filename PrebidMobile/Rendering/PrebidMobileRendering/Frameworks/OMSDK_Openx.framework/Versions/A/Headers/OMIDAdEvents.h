 ...
 */
@interface OMIDOpenxAdEvents : NSObject
 ...
 */
- (nullable instancetype)initWithAdSession:(nonnull OMIDOpenxAdSession *)session error:(NSError * _Nullable * _Nullable)error;
 ...
 */
- (BOOL)loadedWithVastProperties:(OMIDOpenxVASTProperties *_Nonnull)vastProperties
