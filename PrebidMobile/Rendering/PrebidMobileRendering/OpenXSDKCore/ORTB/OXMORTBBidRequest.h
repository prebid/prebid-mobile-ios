...
@class OXMORTBApp;
@class OXMORTBBidRequestExtPrebid;
@class OXMORTBDevice;
@class OXMORTBImp;
@class OXMORTBRegs;
@class OXMORTBSource;
...
@property (nonatomic, copy) NSArray<OXMORTBImp *> *imp;
...
@property (nonatomic, readonly) OXMORTBSource *source;

//A Regs object (Section 3.2.3) that specifies any industry, legal,
//or governmental regulations in force for this request.
@property (nonatomic, strong) OXMORTBRegs *regs;

//Placeholder for exchange-specific extensions to OpenRTB.
//Note: ext object not supported.

@property (nonatomic, strong) OXMORTBBidRequestExtPrebid *extPrebid;
