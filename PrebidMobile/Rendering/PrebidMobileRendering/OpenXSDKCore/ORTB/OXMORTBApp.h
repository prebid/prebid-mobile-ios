...
@class OXMORTBPublisher;
@class OXMORTBAppExtPrebid;
...
@property (nonatomic, strong, nullable) OXMORTBPublisher *publisher;
...
@property (nonatomic, strong) OXMORTBAppExtPrebid *extPrebid;
