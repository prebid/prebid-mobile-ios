//
//  OXANativeAdMarkupEventTracker.h
//  OpenXApolloSDK
//
...
@interface OXANativeAdMarkupEventTracker : NSObject <OXAJsonDecodable>
...
@property (nonatomic, assign) OXANativeEventTrackingMethod method;
