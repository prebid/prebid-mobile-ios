//
//  OXMHTMLCreativeTest_MRAIDOrientationChange.swift
//  OpenXSDKCoreTests
//
...
class OXMHTMLCreativeTest_MRAIDOrientationChange: OXMHTMLCreativeTest_Base {
    ...
    func testForcePortrait() {
        ...
        self.mockModalManager.mock_forceOrientation = { (orientation) in
            OXMAssertEq(orientation, UIInterfaceOrientation.portrait)
            forceOrientationExpectation.fulfill()
        }
    ...
    func testForceLandscape() {
        let forceOrientationExpectation = self.expectation(description: "Should force orientation change")
        self.mockModalManager.mock_forceOrientation = { (orientation) in
            OXMAssertEq(orientation, UIInterfaceOrientation.landscapeLeft)
            forceOrientationExpectation.fulfill()
        }
