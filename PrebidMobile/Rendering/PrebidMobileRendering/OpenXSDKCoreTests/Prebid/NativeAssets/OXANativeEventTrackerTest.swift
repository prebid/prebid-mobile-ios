//
//  OXANativeEventTrackerTest.swift
//  OpenXSDKCoreTests
//
...
class OXANativeEventTrackerTest: XCTestCase {
    func testNativeEventTracker() {
        let tracker = OXANativeEventTracker(event: .impression,
        ...
        tracker.methods = [OXANativeEventTrackingMethod.JS, .img].map { NSNumber(value: $0.rawValue) }
        try? tracker.setExt([
