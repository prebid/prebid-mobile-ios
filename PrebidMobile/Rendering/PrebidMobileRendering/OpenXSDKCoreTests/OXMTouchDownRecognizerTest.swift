//
//  OXMTouchDownRecognizerTest.swift
//  OpenXSDKCoreTests
//
...
class OXMTouchDownRecognizerTests : XCTestCase {
    ...
    func testBasic() {
        ...
        let oxmTouchDownRecognizer = OXMTouchDownRecognizer()
        OXMAssertEq(oxmTouchDownRecognizer.state, UIGestureRecognizer.State.possible)
        ...
        OXMAssertEq(oxmTouchDownRecognizer.state.rawValue, UIGestureRecognizer.State.ended.rawValue)
    }
}
