...
@interface PBMNativeAdConfiguration : NSObject <NSCopying>
...
@property (nonatomic, assign) PBMNativeContextType context;

/// [Integer]
/// A more detailed context in which the ad appears.
@property (nonatomic, assign) PBMNativeContextSubtype contextsubtype;

/// [Recommended]
/// [Integer]
/// The design/format/layout of the ad unit being offered.
@property (nonatomic, assign) PBMNativePlacementType plcmttype;
