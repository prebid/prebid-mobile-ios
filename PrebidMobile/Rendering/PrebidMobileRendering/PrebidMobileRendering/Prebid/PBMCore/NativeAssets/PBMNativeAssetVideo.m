//
//  PBMNativeAssetVideo.m
//  OpenXApolloSDK
//
//  Copyright © 2020 OpenX. All rights reserved.
//

#import "PBMNativeAssetVideo.h"
#import "PBMNativeAsset+Protected.h"
#import "NSNumber+PBMORTBNative.h"

@implementation PBMNativeAssetVideo
...
- (nonnull id)copyWithZone:(nullable NSZone *)zone {
    PBMNativeAssetVideo * const result = [[PBMNativeAssetVideo alloc] initWithMimeTypes:self.mimeTypes
