...
@interface PBMNativeAdEventTracker : NSObject

/// Type of event to track.
/// See Event Types table.
@property (nonatomic, assign, readonly) PBMNativeEventType event;

/// Type of tracking requested.
/// See Event Tracking Methods table.
@property (nonatomic, assign, readonly) PBMNativeEventTrackingMethod method;
