...
typedef NS_ENUM(NSInteger, PBMLocationSource) {
    PBMLocationSourceGPS                = 1,
    PBMLocationSourceIPAddress          = 2,
    PBMLocationSourceUserRegistration   = 3,
};

NS_ASSUME_NONNULL_BEGIN

@interface PBMTargeting : NSObject
 ...
 */
@property (atomic, assign) PBMGender userGender;
/**
 String representation of the users gender,
 where “M” = male, “F” = female, “O” = known to be other (i.e., omitted is unknown)
 */
@property (atomic, copy, readonly, nullable) PBMGenderDescription userGenderDescription;
 ...
 */
@property (atomic, assign) PBMNetworkType networkType;
