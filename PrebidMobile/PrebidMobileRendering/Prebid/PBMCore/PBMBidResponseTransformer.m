...
+ (PBRBidResponse *)transformResponse:(PBMServerResponse *)response error:(NSError **)error {
    ...
    PBRBidResponse * const bidResponse = [[PBRBidResponse alloc] initWithJsonDictionary:response.jsonDict];
    if (!bidResponse) {
        if (error) {
