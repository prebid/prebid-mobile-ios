...
@property (nonatomic, strong, nullable) PBRBidResponse *lastResponseUnsafe; /// backing storage, not protected by 'stateLockToken'
...
- (PBRBidResponse *)lastBidResponse {
    PBRBidResponse *result = nil;
...
- (void)handleDemandResponse:(PBRBidResponse *)bidResponse error:(NSError *)error {
