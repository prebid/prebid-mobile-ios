...
/// `UserConsentParameterBuilder` is responsible for enriching its provided bid request
/// with the GDPR and CCPA consent signals collected from `NSUserDefaults`.
class UserConsentParameterBuilder: NSObject, ParameterBuilder {
