...
Out of scope for this checklist: SwiftLint (diff-scoped, and it gates the PR for itself —
see `docs/lint/README.md`) and build/test commands (the quality-gate ladder in
