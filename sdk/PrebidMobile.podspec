Pod::Spec.new do |s|
  ...
  s.source_files = "PrebidMobile", "PrebidMobile/**/*.{h,m}", "PrebidServerAdapter/**/*.{h,m}"
  s.public_header_files = "PrebidServerAdapter/PBServerAdapter.h", "PrebidMobile/*.h", "PrebidMobile/Logging/*.h"
  s.requires_arc = true
  s.xcconfig = {
