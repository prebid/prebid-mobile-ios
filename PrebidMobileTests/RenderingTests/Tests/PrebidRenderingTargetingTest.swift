...
class PrebidRenderingTargetingTest: XCTestCase {
    ...
    func testAddAppDataObject() {
        ...
        //when
        PrebidRenderingTargeting.shared.addAppDataObject(userDataObject)
        let objects = PrebidRenderingTargeting.shared.getAppDataObjects()

        //then
        XCTAssertEqual(1, objects.count)
        XCTAssertEqual(objects.first, userDataObject)
    }
    
    func testRemoveAppDataObjects() {
        let userDataObject = PBMORTBContentData()
        userDataObject.id = "data id"
        userDataObject.name = "test name"
        
        PrebidRenderingTargeting.shared.addAppDataObject(userDataObject)
        let objects1 = PrebidRenderingTargeting.shared.getAppDataObjects()
        
        XCTAssertEqual(1, objects1.count)
        
        PrebidRenderingTargeting.shared.removeAppDataObject(userDataObject)
        let objects2 = PrebidRenderingTargeting.shared.getAppDataObjects()
        
        XCTAssertEqual(0, objects2.count)
    }
    
    func testClearAppDataObjects() {
        let userDataObject1 = PBMORTBContentData()
        userDataObject1.id = "data id"
        userDataObject1.name = "test name"
        let userDataObject2 = PBMORTBContentData()
        ...
        PrebidRenderingTargeting.shared.clearAppDataObjects()
        let objects2 = PrebidRenderingTargeting.shared.getAppDataObjects()
        XCTAssertEqual(0, objects2.count)
    }
    ...
    func testSetUserDataObjects() {
        ...
        //when
        PrebidRenderingTargeting.shared.setUserDataObjects([userDataObject1, userDataObject2])
        let objects = PrebidRenderingTargeting.shared.getUserDataObjects()
    ...
    func testAddUserDataObject() {
        ...
        //when
        PrebidRenderingTargeting.shared.addUserDataObject(userDataObject)
        let objects = PrebidRenderingTargeting.shared.getUserDataObjects()
    ...
    func testRemoveUserDataObjects() {
        ...
        PrebidRenderingTargeting.shared.addUserDataObject(userDataObject)
        let objects1 = PrebidRenderingTargeting.shared.getUserDataObjects()
        
        XCTAssertEqual(1, objects1.count)
        
        PrebidRenderingTargeting.shared.removeUserDataObject(userDataObject)
        let objects2 = PrebidRenderingTargeting.shared.getUserDataObjects()
    ...
    func testClearUserDataObjects() {
        ...
        PrebidRenderingTargeting.shared.clearUserDataObjects()
        let objects2 = PrebidRenderingTargeting.shared.getUserDataObjects()
        XCTAssertEqual(0, objects2.count)
    }
}
