...
extension PBMBidResponseTransformer {
    ...
    static func makeValidResponseWithTmax(bidPrice: Float, tmaxrequest: Int) -> PrebidServerResponse {
        ...
        return buildResponse("{\"id\":\"B4A2D3F4-41B6-4D37-B68B-EE8893E85C31\",\"seatbid\":[\(winningBidFragment)],\"cur\":\"USD\",\"ext\":{\"responsetimemillis\":{\"openx\":62},\"tmaxrequest\":\(tmaxrequest)}}")
    }
