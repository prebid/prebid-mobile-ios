...
class NativeAdTests: XCTestCase {
    ...
    func testNativeAd() {
        ...
        XCTAssertEqual(nativeAd!.nativeAdMarkup!.link!.url, "https://www.testUrl.com/click?pp=0.1")
        ...
        XCTAssertEqual(nativeAd!.clickURL, "https://www.testUrl.com/click?pp=0.1")
