...
@property (nonatomic) PBMMAXMediationNativeUtils * mediationDelegate;
...
- (void)createAd {
    ...
    self.mediationDelegate = [[PBMMAXMediationNativeUtils alloc] initWithNativeAdLoader:self.maxNativeAdLoader];
