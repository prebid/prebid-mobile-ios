...
@interface CustomRendererDisplayBannerViewController ()
...
@implementation CustomRendererDisplayBannerViewController
...
- (void)createAd {
    ...
    self.prebidBannerView = [[BannerView alloc] initWithFrame:CGRectMake(0, 0, self.adSize.width, self.adSize.height) configID:storedImpDisplayBannerCustomRenderer adSize:self.adSize];
