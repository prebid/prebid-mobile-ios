...
s.name         = "PrebidDemandSDKLoaderForMoPub"
s.version      = "0.1.0"
s.summary      = "PrebidDemandSDKLoaderForMoPub is a lightweight framework that works together with Prebid Mobile & MoPub SDK to load demand that needs to be loaded by that demand's SDK"

s.description  = <<-DESC
PrebidDemandSDKLoaderForMoPub is a lightweight framework that works together with Prebid Mobile to load demand that needs to be loaded by that demand's SDK
DESC
