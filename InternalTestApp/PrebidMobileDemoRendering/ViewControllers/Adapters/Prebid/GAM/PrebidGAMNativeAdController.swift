...
class PrebidGAMNativeAdController: NSObject, AdaptedController {
    ...
    public var adTypes: [AdLoaderAdType] = []
...
extension PrebidGAMNativeAdController: CustomNativeAdLoaderDelegate {
...
extension PrebidGAMNativeAdController: NativeAdLoaderDelegate {
    ...
    private func setAdView(_ view: GoogleMobileAds.NativeAdView) {
