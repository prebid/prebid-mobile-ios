...
import XCTest
@testable import PrebidMobileMAXAdapters

class MAXUtilsTests: XCTestCase {
    ...
    func testServerParameterChecking() {
        ...
        XCTAssertTrue(MAXUtils.isServerParameterInTargetingInfo(serverParameter, targetingInfo))
    }
    ...
    func testMultipleWrongServerParameter() {
        ...
        XCTAssertFalse(MAXUtils.isServerParameterInTargetingInfo(serverParameter, targetingInfo))
    }
