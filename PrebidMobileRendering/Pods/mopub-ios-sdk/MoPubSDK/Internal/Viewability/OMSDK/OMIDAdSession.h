 ...
 */
@interface OMIDMopubAdSession : NSObject

/**
 *  The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly) OMIDMopubAdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(OMIDMopubAdSessionConfiguration *)configuration
                              adSessionContext:(OMIDMopubAdSessionContext *)context
