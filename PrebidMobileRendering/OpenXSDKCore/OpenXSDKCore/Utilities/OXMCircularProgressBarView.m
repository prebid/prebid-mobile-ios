...
@interface OXMCircularProgressBarView ()
@property NSDate *startTime;
@property NSTimeInterval refreshInterval;  // refresh every n seconds.
@end

@implementation OXMCircularProgressBarView  //!OCLINT(too many methods - 35)
...
-(OXMCircularProgressBarLayer*)progressLayer{
    OXMCircularProgressBarLayer* layer = (OXMCircularProgressBarLayer*) self.layer;
    return layer;
}

+ (Class) layerClass {
    return [OXMCircularProgressBarLayer class];
}
