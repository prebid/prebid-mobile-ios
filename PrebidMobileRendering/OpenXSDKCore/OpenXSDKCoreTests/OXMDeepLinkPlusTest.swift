...
class OXMDeepLinkPlusTest: XCTestCase {
    func testDemoLinkParsing() {
        ...
        guard let demoURL = URL(string: demoURLString), let deepLink = OXMDeepLinkPlus(url: demoURL) else {
    ...
    func testAppSettingsLinkParsing() {
        ...
        guard let settingsURL = URL(string: settingsURLString), let deepLink = OXMDeepLinkPlus(url: settingsURL) else {
    ...
    func testBrokenPrimaryLinkParsing() {
        ...
        let deepLink = OXMDeepLinkPlus(url: url)
