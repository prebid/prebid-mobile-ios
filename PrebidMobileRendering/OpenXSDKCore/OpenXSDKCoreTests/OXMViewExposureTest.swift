...
class OXMViewExposureTest: XCTestCase {
    ...
    //
    // => use exact values from 'exposed' to build OXMViewExposure, otherwise 'isEqual' might fail due to rounding errors
    //
    ...
    func testSingleObstruction() {
        ...
        XCTAssertEqual(grandparent.viewExposure, OXMViewExposure(exposureFactor: 44/161.0,
        ...
        XCTAssertEqual(view.viewExposure, OXMViewExposure(exposureFactor: 1/10.0,
        ...
        XCTAssertEqual(view.viewExposure, OXMViewExposure(exposureFactor: 3/10.0,
        ...
        XCTAssertEqual(obstruction.viewExposure, OXMViewExposure(exposureFactor: 1/7.0,
    ...
    func testMultipleObstructions() {
        ...
        XCTAssertEqual(parent.viewExposure, OXMViewExposure(exposureFactor: 1668/2400.0,
        ...
        XCTAssertEqual(adView.viewExposure, OXMViewExposure(exposureFactor: 604/1176.0,
        ...
        XCTAssertEqual(brother.viewExposure, OXMViewExposure(exposureFactor: 1,
                                                             visibleRectangle: CGRect(x: 0, y: 0, width: 360, height: 80)));
        
        XCTAssertEqual(xBtn.viewExposure, OXMViewExposure(exposureFactor: 1,
                                                          visibleRectangle: CGRect(x: 0, y: 0, width: 120, height: 40)));
        
        XCTAssertEqual(uncle.viewExposure, OXMViewExposure(exposureFactor: 1,
                                                           visibleRectangle: CGRect(x: 0, y: 0, width: 240, height: 80)));
        
        XCTAssertEqual(aunt.viewExposure, OXMViewExposure(exposureFactor: 1,
                                                          visibleRectangle: CGRect(x: 0, y: 0, width: 540, height: 100)));
        
        XCTAssertEqual(cousin.viewExposure, OXMViewExposure(exposureFactor: 1,
