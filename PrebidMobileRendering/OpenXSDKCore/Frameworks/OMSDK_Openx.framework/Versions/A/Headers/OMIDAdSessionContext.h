 ...
 */
@interface OMIDOpenxAdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(OMIDOpenxPartner *)partner
...
- (nullable instancetype)initWithPartner:(OMIDOpenxPartner *)partner
                               ...
                               resources:(NSArray<OMIDOpenxVerificationScriptResource *> *)resources
                              contentUrl:(nullable NSString *)contentUrl
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
